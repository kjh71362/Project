...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
     <a href="index.jsp"><img src="images/logo2.png" id="icon" alt="User Icon" /></a> 
    </div>

    <!-- Login Form -->
    <form method="post" name="form1" id="form1"
    action="${path}/Tlmember_servlet/login.do">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="index.jsp">홈</a> | <a class="underlineHover" href="sign.jsp">회원가입</a>
    </div>
