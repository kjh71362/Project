...
function insert(){
	...
	$.ajax({
		type: "post",
		url: "/jsp02/Tlmember_servlet/join.do",
		data: param,
		success:function(){
		    alert("가입이 완료되었습니다.");
			$("#userid").val("");
...
<div class="container"><!-- 좌우측의 공간 확보 -->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="text-right">
                    <small>
                    <a href="login.jsp">로그인</a> | <a href="sign.jsp">회원가입</a>
                    </small>
                    </p>
                </div>
            </div>
        ...
        <form class="form-horizontal" role="form" method="post" action="javascript:alert( 'success!' );">
            ...
            <div class="form-group" id="divPhoneNumber">
                ...
                <div class="col-lg-10">
                    <input type="tel" class="form-control onlyNumber" id="hp" data-rule-required="true" placeholder="-를 포함한 숫자를 입력하세요." maxlength="15">
                </div>
            </div>
            <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                    <button type="button" class="btn btn-default" id="btnSave">Sign in</button>
                </div>
            </div>
        </form>
