...
$(function(){
	...
	$("#btnList").click(function(){
		location.href="${path}/tlkpop_servlet/list.do";
	});
	$("#btnEdit").click(function(){
		document.form1.action="${path}/tlkpop_servlet/pass_check.do";
...
function comment_add(){
	var param="tlkpop_num=${dto.num}&writer="+$("#writer").val()
	+"&content="+$("#content").val();
	$.ajax({
		type: "post",
		url: "${path}/tlkpop_servlet/comment_add.do",
		data: param,
		success: function(){
			$("#writer").val("");
			$("#content").val("");
...
function comment_list(){
	$.ajax({
		type: "post",
		url: "${path}/tlkpop_servlet/commentList.do",
		data: "num=${dto.num}",
...
<table class="table table-striped">
	...
	<tr>
		...
		<img src="${path}/hiphop/file/${dto.filename}"><br>
		<p id="main">${dto.content}</p></td>
	</tr>
